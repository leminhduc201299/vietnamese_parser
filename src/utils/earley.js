function init(g, t) {
    ...
    var grammar = new tinynlp.Grammar(g);
    ...
    var temp = chart.getFinishedRoot(rootRule)
    if (temp) {
        let trees = temp.traverse();
        ...
        for (var i in trees) {
            ...
            document.getElementById('treeChart').innerHTML += '<div class="tree" id="displayTree"><ul>' + displayTree(trees[i]) + '</ul></div></br><br/><br/>'
        }
    }
